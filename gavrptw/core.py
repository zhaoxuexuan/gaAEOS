...
#                if (tempchild1 == child1) and (tempchild2 == child2): print('no change after crossover!!!!!!')
...
# =============================================================================
#         # zhaoxx test   
#         for ind1,ind2 in zip(test,offspring):
#             if ind1.fitness.values != ind2.fitness.values: 
#                 print('pop and offspring are not same!')
#         # end test
# =============================================================================
